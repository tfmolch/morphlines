...
import com.stratio.morphlines.commons.dict.VgrokDictionaries;
...
public final class VgrokBuilder implements CommandBuilder {
   ...
   */
    ...
    public Collection<String> getNames() {
        return Collections.singletonList("vgrok");
    }

    @Override
    public Command build(Config config, Command parent, Command child, MorphlineContext context) {
        return new Vgrok(this, config, parent, child, context);
    }
    ...
    // Nested classes:
    ///////////////////////////////////////////////////////////////////////////////
    private static final class Vgrok extends AbstractCommand {

        private final String VGROK_ERROR_FIELD_NAME = "vgrok_error_fields";
        ...
        public Vgrok(CommandBuilder builder, Config config, Command parent, Command child, MorphlineContext context) {
            super(builder, config, parent, child, context);

            VgrokDictionaries dict = new VgrokDictionaries(config, getConfigs());
        ...
        private boolean doMatch(Record inputRecord, Record outputRecord, boolean doExtract) {
                    ...
                    if (!findSubstrings) {
                        if (matcher.matches()) {
                            ...
                            if (numMatches > maxMatches) {
                                ...
                                errorFields.add(regex.getRecordInputField());
                            }
            ...
            if(!errorFields.isEmpty()) {
                outputRecord.put(VGROK_ERROR_FIELD_NAME, errorFields.toString());
            }
            return true;
        }
